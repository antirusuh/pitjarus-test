...
INSERT INTO `report_products` (`id`, `store_id`, `product_id`, `compliance`, `tanggal`) VALUES
(1, 1, 1, 1, '2021-01-01'),
(2, 1, 2, 1, '2021-01-01'),
(3, 1, 3, 0, '2021-01-01'),
(4, 1, 4, 0, '2021-01-01'),
...
INSERT INTO `stores` (`id`, `store_name`, `account_id`, `area_id`, `is_active`) VALUES
...
INSERT INTO `store_accounts` (`id`, `account_name`) VALUES
(1, 'Indomaret'),
(2, 'Hypermarket');
...
INSERT INTO `store_areas` (`id`, `area_name`) VALUES
(1, 'DKI jakarta'),
(2, 'Jawa Barat'),
(3, 'Kalimantan'),
(4, 'Jawa Tengah'),
